# ------------------------------------------------------------------------------
# Data cleansing/wrangling with Lahman baseball data only
...
if (TRUE) {
  ...
  if (save_csv) {
    fwrite(d_pit_train, file = "C:/Users/Adam/Documents/GitHub/moneyball/cache_data/Wrangled_data/d_pit_train.csv")
    fwrite(d_pit_valid, file = "C:/Users/Adam/Documents/GitHub/moneyball/cache_data/Wrangled_data/d_pit_valid.csv")
    fwrite(d_pit_test, file = "C:/Users/Adam/Documents/GitHub/moneyball/cache_data/Wrangled_data/d_pit_test.csv")
  }
...
if (TRUE) {
  ...
  # Save reformatted datasets as cache
  if (save_csv) {
    fwrite(d_bat_train, file ="C:/Users/Adam/Documents/GitHub/moneyball/cache_data/Wrangled_data/d_bat_train.csv")
    fwrite(d_bat_valid, file = "C:/Users/Adam/Documents/GitHub/moneyball/cache_data/Wrangled_data/d_bat_valid.csv")
    fwrite(d_bat_test, file = "C:/Users/Adam/Documents/GitHub/moneyball/cache_data/Wrangled_data/d_bat_test.csv")
