...
# ------------------------------------------------------------------------------
# Load cleansed Datasets from 'data_munging.R'
# ------------------------------------------------------------------------------


# Load reformatted data
d_train = fread("C:/Users/Adam/Documents/GitHub/moneyball/cache_data/Wrangled_data/d_pit_train.csv")
d_valid = fread("C:/Users/Adam/Documents/GitHub/moneyball/cache_data/Wrangled_data/d_pit_valid.csv")
d_test = fread("C:/Users/Adam/Documents/GitHub/moneyball/cache_data/Wrangled_data/d_pit_test.csv")
...
fileName = paste(prediction_folder, 'all_with_pred.csv')
